...
Original file is located at
    https://colab.research.google.com/drive/1IyAkliLZgbtVYzMc_3K8ywEPSfeS5yaq
"""
...
print("Coeficientes forma padrao: "+ str(coeficientes))
...
print("B_SOLUCOES É: " + str(B_solucoes))
...
print ("A solucao otima eh: " + str(maior))